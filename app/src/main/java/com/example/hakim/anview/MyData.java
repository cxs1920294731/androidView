...
public class MyData extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table save_text_table (id integer,content varchar(225),numId integer)");
        sqLiteDatabase.execSQL("create table send_result_table (id integer,num varchar(225),res varchar(255),numId integer)");
    }
    @Override
